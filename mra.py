...
def Daubechies(points):
	...
	v4 = np.array([0.5353, 1.0320, 0.8207, 0.0681, -0.1900, 0.0174, -0.0015, 0])
	v5 = np.array([0.3657, 0.7049, 0.9372, 1.1267, 1.1519, 0.4895, 0.1467, -0.0105, -0.2238, -0.1561, 0.0034, 0.0313, -0.0033, 0.0003, 0, 0])
